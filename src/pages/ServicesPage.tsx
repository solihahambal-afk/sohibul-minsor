...
export default function ServicesPage() {
  ...
  useEffect(() => {
    setIsLoading(true);
    const unsubscribe = apiClient.from('services').select('*').eq('status', 'Active')
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="bg-primary-900 p-8 rounded-2xl shadow-sm md:col-span-2 lg:col-span-2 text-white flex flex-col justify-between"
          >
            <div>
            ...
            <Link to="/hajj-umrah" className="inline-block bg-gold-500 text-primary-900 text-center py-3 px-6 w-full rounded-lg font-bold text-sm hover:bg-gold-400 transition-colors">
              View Packages
            </Link>
          </motion.div>
